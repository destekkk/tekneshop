  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border bg-[#fafafa] px-4 py-2.5">
      <div className="min-w-0">
        <Link href="/tekne" className="text-[15px] font-bold text-foreground hover:text-navy">
          Sıfır ve ikinci el tekne ilanları
        </Link>
        <p className="mt-0.5 hidden text-[12px] text-muted sm:block">
          Soldan kategori seçin — doğrudan satıcıya mesaj ve teklif gönderin.
        </p>
      </div>
