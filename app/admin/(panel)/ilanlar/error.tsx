...
export default function AdminListingsError({
  ...
  return (
    <div className="mx-auto max-w-lg space-y-4 rounded-lg border border-rose-200 bg-rose-50 p-6">
      <h1 className="text-lg font-bold text-rose-900">İlanlar yüklenemedi</h1>
      <p className="text-[13px] text-rose-800">
        Sunucu hatası oluştu. Veritabanı şeması güncel değilse bilgisayarınızda{" "}
        <code className="rounded bg-rose-100 px-1">npm run db:push</code> çalıştırın, ardından
        sayfayı yenileyin.
      </p>
      {error.digest ? (
